package com.sumpay.wallet.wallets.sumcoin;
...
import com.sumpay.R;
import com.sumpay.core.BRCoreAddress;
import com.sumpay.core.BRCoreChainParams;
import com.sumpay.core.BRCoreKey;
import com.sumpay.core.BRCoreMasterPubKey;
import com.sumpay.core.BRCoreMerkleBlock;
import com.sumpay.core.BRCorePeer;
import com.sumpay.core.BRCorePeerManager;
import com.sumpay.core.BRCoreTransaction;
import com.sumpay.core.BRCoreWallet;
import com.sumpay.core.BRCoreWalletManager;
import com.sumpay.core.ethereum.BREthereumAmount;
import com.sumpay.presenter.customviews.BRToast;
...
import com.sumpay.presenter.entities.TxUiHolder;
import com.sumpay.presenter.interfaces.BROnSignalCompletion;
import com.sumpay.tools.animation.UiUtils;
import com.sumpay.tools.animation.BRDialog;
import com.sumpay.tools.manager.BRApiManager;
import com.sumpay.tools.manager.BRNotificationManager;
import com.sumpay.tools.manager.BRReportsManager;
import com.sumpay.tools.manager.BRSharedPrefs;
import com.sumpay.tools.manager.InternetManager;
...
import com.sumpay.tools.sqlite.TransactionStorageManager;
import com.sumpay.tools.threads.executor.BRExecutor;
import com.sumpay.tools.util.BRConstants;
import com.sumpay.tools.util.CurrencyUtils;
...
import com.sumpay.wallet.configs.WalletSettingsConfiguration;
import com.sumpay.wallet.configs.WalletUiConfiguration;
import com.sumpay.wallet.wallets.CryptoAddress;
...
import static com.sumpay.tools.util.BRConstants.ROUNDING_MODE;
...
public abstract class BaseSumcoinWalletManager extends BRCoreWalletManager implements BaseWalletManager {
    ...
    protected BRCoreWallet createWalletRetry() {
        ...
        if (0 == mCreateWalletAllowedRetries) {
            ...
            BRDialog.showSimpleDialog(app, "Wallet error!", "please contact support@sumpay.com");
