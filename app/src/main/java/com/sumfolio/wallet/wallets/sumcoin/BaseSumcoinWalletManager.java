...
import com.sumfolio.core.BRCoreMerkleBlock;
import com.sumfolio.core.BRCorePeer;
import com.sumfolio.core.BRCorePeerManager;
import com.sumfolio.core.BRCoreTransaction;
import com.sumfolio.core.BRCoreWallet;
import com.sumfolio.core.BRCoreWalletManager;
import com.sumfolio.core.ethereum.BREthereumAmount;
import com.sumfolio.presenter.customviews.BRToast;
...
import com.sumfolio.presenter.entities.TxUiHolder;
import com.sumfolio.presenter.interfaces.BROnSignalCompletion;
import com.sumfolio.tools.animation.UiUtils;
import com.sumfolio.tools.animation.BRDialog;
import com.sumfolio.tools.manager.BRApiManager;
import com.sumfolio.tools.manager.BRNotificationManager;
import com.sumfolio.tools.manager.BRReportsManager;
import com.sumfolio.tools.manager.BRSharedPrefs;
import com.sumfolio.tools.manager.InternetManager;
...
import com.sumfolio.tools.sqlite.TransactionStorageManager;
import com.sumfolio.tools.threads.executor.BRExecutor;
import com.sumfolio.tools.util.BRConstants;
import com.sumfolio.tools.util.CurrencyUtils;
import com.sumfolio.tools.util.TypesConverter;
...
import com.sumfolio.wallet.abstracts.OnBalanceChangedListener;
import com.sumfolio.wallet.abstracts.OnTxListModified;
import com.sumfolio.wallet.abstracts.SyncListener;
import com.sumfolio.wallet.configs.WalletSettingsConfiguration;
import com.sumfolio.wallet.configs.WalletUiConfiguration;
import com.sumfolio.wallet.wallets.CryptoAddress;
import com.sumfolio.wallet.wallets.CryptoTransaction;
import com.sumfolio.wallet.wallets.WalletManagerHelper;
...
import static com.sumfolio.tools.util.BRConstants.ROUNDING_MODE;

public abstract class BaseSumcoinWalletManager extends BRCoreWalletManager implements BaseWalletManager {
    ...
    BaseSumcoinWalletManager(Context context, BRCoreMasterPubKey masterPubKey, BRCoreChainParams chainParams, double earliestPeerTime) {
    ...
    protected BRCoreWallet createWalletRetry() {
        ...
        if (0 == mCreateWalletAllowedRetries) {
            ...
            BRDialog.showSimpleDialog(app, "Wallet error!", "please contact support@sumfolio.com");
