...
import com.sumfolio.tools.adapter.ManageTokenListAdapter;
import com.sumfolio.tools.animation.SimpleItemTouchHelperCallback;
import com.sumfolio.tools.listeners.OnStartDragListener;
    ...
    protected void onResume() {
        ...
        for (int i = 0; i < mTokens.size(); i++) {
            ...
            if (!tokenSymbol.equalsIgnoreCase("sum") && !tokenSymbol.equalsIgnoreCase("bch") &&
                ...
                tokenItem = new TokenItem(null, "BCH", "Sumcoin Cash", null);
