...
import com.sumfolio.presenter.customviews.BRButton;
import com.sumfolio.presenter.customviews.BRSearchBar;
...
import com.sumfolio.tools.manager.DeepLinkingManager;
import com.sumfolio.tools.manager.FontManager;
import com.sumfolio.tools.manager.InternetManager;
import com.sumfolio.tools.manager.TxManager;
import com.sumfolio.tools.services.SyncService;
...
import com.sumfolio.tools.util.SyncTestLogger;
...
import com.sumfolio.wallet.wallets.sumcoin.BaseSumcoinWalletManager;
...
public class WalletActivity extends BRActivity implements InternetManager.ConnectionReceiverListener,
    ...
    public void updateSyncProgress(double progress) {
        if (progress != SyncService.PROGRESS_FINISH) {
            ...
            if (mWallet instanceof BaseSumcoinWalletManager) {
                BaseSumcoinWalletManager baseSumcoinWalletManager = (BaseSumcoinWalletManager) mWallet;
                long syncThroughDateInMillis = baseSumcoinWalletManager.getPeerManager().getLastBlockTimestamp() * DateUtils.SECOND_IN_MILLIS;
