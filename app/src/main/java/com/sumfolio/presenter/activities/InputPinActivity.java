...
import com.sumfolio.presenter.customviews.PinLayout;
...
public class InputPinActivity extends BRActivity implements PinLayout.OnPinInserted {
    ...
    public static final String EXTRA_PIN_MODE_UPDATE = "com.sumfolio.EXTRA_PIN_MODE_UPDATE";
    public static final String EXTRA_PIN_ACCEPTED = "com.sumfolio.EXTRA_PIN_ACCEPTED";
