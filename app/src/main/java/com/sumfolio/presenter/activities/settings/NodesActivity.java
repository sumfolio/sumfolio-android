package com.sumfolio.presenter.activities.settings;
...
//    private TextView nodeLabel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BRSharedPrefs.putCurrentWalletIso(this, "SUM");
        ...
        switchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final WalletSumcoinManager wm = WalletSumcoinManager.getInstance(NodesActivity.this);
    ...
    private void updateButtonText() {
        WalletSumcoinManager wm = WalletSumcoinManager.getInstance(this);
