...
import com.sumfolio.presenter.customviews.BRNotificationBar;
import com.sumfolio.presenter.customviews.BaseTextView;
import com.sumfolio.tools.adapter.WalletListAdapter;
import com.sumfolio.tools.animation.UiUtils;
import com.sumfolio.tools.listeners.RecyclerItemClickListener;
...
import com.sumfolio.tools.manager.PromptManager;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBuyLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String url = String.format(BRConstants.CURRENCY_PARAMETER_STRING_FORMAT, HTTPServer.URL_BUY, WalletSumcoinManager.getInstance(HomeActivity.this).getIso());
